...
c.IPControllerApp.engine_ssh_server = 'patron'
...
# should be of the form: [user@]server[:port]. The Controller's listening
# addresses must be accessible from the ssh server
c.IPControllerApp.ssh_server = 'patron'
