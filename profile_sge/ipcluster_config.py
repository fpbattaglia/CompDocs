...
# c.IPClusterStart.work_dir = u'/home/battaglia'
...
# Set the working dir for the process.
# c.IPClusterEngines.work_dir = u'/home/battaglia'
...
# c.LocalControllerLauncher.controller_cmd = ['/peones/peon001/battaglia/anaconda/bin/python', '-m', 'IPython.parallel.controller']
...
# c.LocalEngineLauncher.engine_cmd = ['/peones/peon001/battaglia/anaconda/bin/python', '-m', 'IPython.parallel.engine']
...
# command to launch the Engine.
# c.LocalEngineSetLauncher.engine_cmd = ['/peones/peon001/battaglia/anaconda/bin/python', '-m', 'IPython.parallel.engine']
...
# Popen command to launch ipcontroller.
# c.MPIControllerLauncher.controller_cmd = ['/peones/peon001/battaglia/anaconda/bin/python', '-m', 'IPython.parallel.controller']
...
# command to launch the Engine.
# c.MPIEngineSetLauncher.engine_cmd = ['/peones/peon001/battaglia/anaconda/bin/python', '-m', 'IPython.parallel.engine']
...
# Popen command to launch ipcontroller.
# c.SSHControllerLauncher.controller_cmd = ['/peones/peon001/battaglia/anaconda/bin/python', '-m', 'IPython.parallel.controller']
...
# command to launch the Engine.
# c.SSHEngineLauncher.engine_cmd = ['/peones/peon001/battaglia/anaconda/bin/python', '-m', 'IPython.parallel.engine']
...
# command to launch the Engine.
# c.SSHEngineSetLauncher.engine_cmd = ['/peones/peon001/battaglia/anaconda/bin/python', '-m', 'IPython.parallel.engine']
...
c.SGEControllerLauncher.controller_args = ["--ip='*'"]
#------------------------------------------------------------------------------
